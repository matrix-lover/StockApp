...
@dso_cache = dso_local local_unnamed_addr global [498 x %struct.DSOCacheEntry] [
	%struct.DSOCacheEntry {
		i64 15594019542809952, ; hash 0x3766ad9b783d60, from name: aot-StockApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-StockApp.dll.so
	...
	%struct.DSOCacheEntry {
		i64 1234785897713353048, ; hash 0x1122d73b56ddc158, from name: StockApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-StockApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 31
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.21_name, ; name: libaot-System.Diagnostics.DiagnosticSource.dll.so
		ptr null; void* handle (0x0)
	}, ; 51
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3080469435371032584, ; hash 0x2ac006a164bd1008, from name: libaot-StockApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-StockApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 79
	...
	%struct.DSOCacheEntry {
		i64 7630152286544093902, ; hash 0x69e3bf140d9862ce, from name: libaot-StockApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-StockApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 186
	...
	%struct.DSOCacheEntry {
		i64 8294163993822029025, ; hash 0x731aca354098e4e1, from name: aot-StockApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-StockApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 209
	...
	%struct.DSOCacheEntry {
		i64 13865310906899903145, ; hash 0xc06b7aceea1e32a9, from name: StockApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-StockApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 374
...
@.env.3 = private unnamed_addr constant [37 x i8] c"abae478c-f734-4d1e-a463-7f791fcd04ba\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [25 x i8] c"com.companyname.stockapp\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [23 x i8] c"libaot-StockApp.dll.so\00", align 16
...
@.DSOCacheEntry.21_name = private unnamed_addr constant [50 x i8] c"libaot-System.Diagnostics.DiagnosticSource.dll.so\00", align 16
