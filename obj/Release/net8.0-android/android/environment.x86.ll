...
@dso_cache = dso_local local_unnamed_addr global [498 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 61502065, ; hash 0x3aa7271, from name: libaot-StockApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 209173336, ; hash 0xc77bb58, from name: StockApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-StockApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 20
	...
	%struct.DSOCacheEntry {
		i64 368878010, ; hash 0x15fca1ba, from name: StockApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-StockApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 44
	...
	%struct.DSOCacheEntry {
		i64 1607190129, ; hash 0x5fcbc671, from name: aot-StockApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-StockApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 175
	...
	%struct.DSOCacheEntry {
		i64 2412882301, ; hash 0x8fd1a97d, from name: libaot-StockApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-StockApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 277
	...
	%struct.DSOCacheEntry {
		i64 3536202548, ; hash 0xd2c62b34, from name: aot-StockApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-StockApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 413
